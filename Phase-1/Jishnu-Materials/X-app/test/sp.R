...
#reading input file
data = read.xlsx(args[1], sheetName = "Sheet1", header = TRUE)
...
A = as.numeric(args[2]) #total amount to be used to conduct experiment
...
for(i in 1:length(M))
{
  ...
  #cat("pilot data", pilot_data, " | pilot data[1]", pilot_data[0], "\n")
